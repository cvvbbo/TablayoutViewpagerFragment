...
public   class MenuViewPagerForFragment1 extends FragmentStatePagerAdapter {

    ArrayList<BaseFragment> fg=new ArrayList<>();
    ...
    public MenuViewPagerForFragment1(FragmentManager fm, String[] s) {
        super(fm);
        this.tabtitle=s;
    }
